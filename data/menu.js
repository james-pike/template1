...
export const portfolioItems = [
  { name: "Service 01", link: "/portfolio/portfolio-v1" },
  { name: "Service 02", link: "/portfolio/portfolio-v2" },
  { name: "Service 03", link: "/portfolio/portfolio-v3" },
  { name: "Service 04", link: "/portfolio/portfolio-v4" },
  { name: "Service 05", link: "/portfolio/portfolio-v5" },
  { name: "Service 06", link: "/portfolio/portfolio-v6" },
  { name: "Service 07", link: "/portfolio/portfolio-v7" },
  { name: "Service Details", link: "/portfolio/1" },
];
...
export const contactItems = [
  { link: "/contact/contact-v1", text: "Web Design" },
  { link: "/contact/contact-v2", text: "Web Development" },
  { link: "/contact/contact-v3", text: "Digital Marketing" },
  { link: "/contact/contact-v4", text: "Hosting & Optimization" },
];
